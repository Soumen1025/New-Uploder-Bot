...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8506724794:AAEc1-24e_GNlmMmadAkpggFooF6ugwLd9o")
...
ADMINS = [int(x) for x in os.environ.get("ADMINS", "8229228616").split()]  # Default to owner ID
